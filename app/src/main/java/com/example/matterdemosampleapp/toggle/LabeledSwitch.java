...
//Drawing Switch background here
        ...
        int tempAlpha = (int) (((thumbBounds.centerX() - thumbOffCenterX) / (thumbOnCenterX - thumbOffCenterX)) * 255);
        tempAlpha = (tempAlpha < 0 ? 0 : (tempAlpha > 255 ? 255 : tempAlpha));
        int onColor;

        if (isEnabled()) {
            onColor = Color.argb(tempAlpha, Color.red(colorOn), Color.green(colorOn), Color.blue(colorOn));
        } else {
            onColor = Color.argb(tempAlpha, Color.red(colorDisabled), Color.green(colorDisabled), Color.blue(colorDisabled));
        }
        ...
        tempAlpha = (int) (((thumbOnCenterX - thumbBounds.centerX()) / (thumbOnCenterX - thumbOffCenterX)) * 255);
        tempAlpha = (tempAlpha < 0 ? 0 : (tempAlpha > 255 ? 255 : tempAlpha));
        int offColor = 0;
        offColor = Color.argb(Color.alpha(colorOff), Color.red(colorOff), Color.green(colorOff), Color.blue(colorOff));
        ...
        if (isOn) {
            ...
            int tempOnColor = Color.argb(alpha, Color.red(colorOn), Color.green(colorOn), Color.blue(colorOn));
            paint.setColor(tempOnColor);
            ...
            alpha = (alpha < 0 ? 0 : (alpha > 255 ? 255 : alpha));
            int tempOffColor = Color.argb(alpha, Color.red(colorOff), Color.green(colorOff), Color.blue(colorOff));
            paint.setColor(tempOffColor);
            ...
            int tempOnColor;
            if (isEnabled()) {
                tempOnColor = Color.argb(alpha, Color.red(colorOn), Color.green(colorOn), Color.blue(colorOn));
            } else {
                tempOnColor = Color.argb(alpha, Color.red(colorDisabled), Color.green(colorDisabled), Color.blue(colorDisabled));
            }
            paint.setColor(tempOnColor);
        ...
        paint.setColor(getContext().getColor(R.color.system_content_white));
        canvas.drawCircle(thumbBounds.centerX(), thumbBounds.centerY(), thumbRadii, paint);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        thumbRadii = (int) (Math.min(width, height) / (2.55f));
