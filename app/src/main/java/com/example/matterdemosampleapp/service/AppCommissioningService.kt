...
import com.example.matterdemosampleapp.utils.AppUtils
...
//            val deviceId = getNextDeviceId(DeviceIdGenerator.Random)
            val deviceId = AppUtils.generateNextDeviceId()
            try {
                Log.d(
                    TAG,
                ...
                /**
                 * The ChipClient uses this metadata information to create a secure channel between the app and your device.
                 *
                 * */
